...
from flowchem.components.technical.box import ElectronicADCBox, ElectronicDACBox, ElectronicHeleBox
...
class SwitchBoxDAC(ElectronicDACBox):
...
class SwitchBoxADC(ElectronicADCBox):
...
class SwitchBoxHele(ElectronicHeleBox):
    ...
    async def set_channel(
        ...
        """
        return await self.hw_device.set_hele_single_channel(
            channel=int(channel),
            value=int(value),
    ...
    async def get_all(self) -> dict[str, list[int]]:
        ...
        """
        return await self.hw_device.get_hele_channels()
    ...
    async def set_ports(
        ...
        return await self.hw_device.set_hele_port(
