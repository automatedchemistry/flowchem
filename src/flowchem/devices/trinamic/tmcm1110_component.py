"""Flowchem component for a TMCM-1110 linear fraction collector."""
...
class TMCM1110FractionCollector(FlowchemComponent):
    """Named-position interface for a single-axis TMCM-1110 fraction collector."""

    hw_device: TMCM1110

    def __init__(self, name: str, hw_device: "TMCM1110") -> None:
